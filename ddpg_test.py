...
if __name__ == "__main__":
    ...
    env_test = TradingEnv(continuous_action_flag=True, sabr_flag=False, dg_random_seed=None, spread=0.01, num_contract=1, init_ttm=90, trade_freq=1, num_sim=1000)
    ...
    ddpg_test.test(1000, delta_flag=delta_action_test, bartlett_flag=bartlett_action_test)
