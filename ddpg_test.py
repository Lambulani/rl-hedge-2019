...
if __name__ == "__main__":
    ...
    env_test = TradingEnv(continuous_action_flag=True, sabr_flag=False, dg_random_seed=None, spread=0.01, num_contract=1, init_ttm=10, trade_freq=0.2, num_sim=38500)
    ...
    ddpg_test.test(38500, delta_flag=delta_action_test, bartlett_flag=bartlett_action_test)
